...
namespace Buddy.Utilities
{
    public class Helper: HelperBase
    {
        ...
        public Dictionary<string, string> GetAllAppKeys()
        {
            ...
            document.Load(System.AppDomain.CurrentDomain.BaseDirectory + "/Web.config");
        ...
        public bool SaveBase64FileToServer(string filePath, string FileName, string FileData)
        {
            if (FileData.Contains("base64,"))
            {
                ...
                string filePhysicalPath = Path.Combine(filePath, FileName);
        ...
        {
            string WebConfigPath = Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, "~/Web.Config");
